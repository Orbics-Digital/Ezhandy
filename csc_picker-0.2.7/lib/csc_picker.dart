...
class CSCPicker extends StatefulWidget {
  ...
  CSCPicker({
    ...
    this.error_text_country,
    this.error_text_city,
    this.error_text_state,
  ...
  final bool showClearButton, isCountryShow;
  ...
  String? error_text_country;
  String? error_text_state;
  String? error_text_city;
...
class CSCPickerState extends State<CSCPicker> {
      ...
      children: [
        ...
        widget.layout == Layout.vertical
            ? Column(
                ...
                children: <Widget>[
                  Visibility(
                      visible: widget.isCountryShow, child: countryDropdown()),
                  Visibility(
                    visible: widget.isCountryShow,
                    child: SizedBox(
                      height: 10.0,
                    ),
                  ),
  ...
  Widget countryDropdown() {
    return DropdownWithSearch(
      // isIconShow: widget.disableCountry?,
      iconColor: widget.disableCountry ? Colors.transparent : widget.iconColor,
      ...
      error_text: widget.error_text_country,
  ...
  Widget stateDropdown() {
    return DropdownWithSearch(
      ...
      dialogRadius: widget.dropdownDialogRadius,
      searchBarRadius: widget.searchBarRadius,
      error_text: widget.error_text_state,
  ...
  Widget cityDropdown() {
    return DropdownWithSearch(
      ...
      error_text: widget.error_text_city,
